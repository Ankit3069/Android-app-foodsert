...
public class ShopOrderAdapter extends RecyclerView.Adapter<ShopOrderAdapter.ViewHolder> {
    ...
    public ShopOrderAdapter(Context context, List<Order> discountList) {
    ...
    public String getName(Order discount)
    {
        ...
        Cursor reult2 = controller.getUserDetails(String.valueOf(discount.getUserId()));
    ...
    public void getDetails(Order discount)
    {
        ...
        if(reult2.getCount()>0)
        {
            ...
            contact = reult2.getString(4);
            add = reult2.getString(5);
